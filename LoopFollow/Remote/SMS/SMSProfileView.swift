// LoopFollow
// SMSProfileView.swift
// Created by codebymini.

import SwiftUI

struct SMSProfileView: View {
            ...
            VStack(spacing: 20) {
                ...
                Form {
                    ...
                    Section {
                        ...
                        .disabled(isLoading || !SMSRemoteService.shared.validateSetup() || (selectedAction == "SWITCH" && profileName.isEmpty))
                    }
                }
    ...
    private func sendProfileCommand() {
        ...
        Task {
            do {
                ...
                let success = try await SMSRemoteService.shared.sendProfileCommand(action: selectedAction, profile: profile, otp: otpCode)
                await MainActor.run {
                    isLoading = false
                    if success {
                        alertType = .success
